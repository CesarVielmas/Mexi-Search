...
@Composable
fun DatePickerComponent(onDateSelected: (String) -> Unit, screenHeightTotal: Int) {
        ...
        var selectedDate by remember {
                mutableStateOf("${currentDay}/${months[selectedMonthIndex]}/${currentYear}")
        }
...
fun DatePickerView(
        ...
        val daysInMonth =
                remember(selectedYear, selectedMonthIndex) {
                        val calendar =
                ...
                LazyColumn(
                        ...
                        items(years) { year ->
                                Text(
                                        ...
                                        fontSize = 14.sp,
                                        color =
                                                if (year == selectedYear) Color(0xFFFFFFFF)
                                                else
                                                        Color(
                                                                0xFF000000
                ...
                LazyColumn(
                        ...
                        items(months) { month ->
                                Text(
                                        ...
                                        fontSize = 14.sp,
                                        color =
                                                if (months.indexOf(month) == selectedMonthIndex)
                                                        Color(0xFFFFFFFF)
                                                else
                                                        Color(
                                                                0xFF000000
                ...
                LazyColumn(
                        ...
                        items(adjustedDays) { day ->
                                Text(
                                        ...
                                        fontSize = 14.sp,
                                        color =
                                                if (day == selectedDay) Color(0xFFFFFFFF)
                                                else
                                                        Color(
                                                                0xFF000000
                                                        ), // Color del texto según selección
